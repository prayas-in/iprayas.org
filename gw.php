    ...
    <div class="row col-p0">
        <div class="col-sm-12 col-md-6 sm-box3">
            <div class="section-boxed pt0 pb0">
                <iframe src="https://player.vimeo.com/video/39822385" class="rs-video fix-iframe-mb" frameborder="0"
                ...
                <div class="box-services-2">
                    ...
                    <div class="box-right">
                        ...
                        <p>To an English person, it will seem like simplified English, as a skeptical Cambridge friend
                            of mine told me what Occidental is.</p>
                ...
                <div class="box-services-4 el_max_height">
                    ...
                    <div class="row col-p0">
                        <div class="col-sm-12">
                            ...
                            <p class="mb0 ">If several languages coalesce, the grammar of the resulting language is more
            ...
            <div class="row col-p0">
                <div class="col-md-5 get-height">
                    <div class="mb50 mt50">
                        ...
                        <div class="br-bottom mb20"></div>
                        <p class="mb50">The European languages are members of the same family. Their separate existence
...
<section class="section-bg mb0 with-btn-bottom section-large bg-pattern stellar bg04"
    data-stellar-background-ratio="0.4">
    <div class="bg-overlay gradient-1"></div>
    <div class="container">
        <div class="row mt70 mb70">
            <div class="col-md-8 col-md-offset-2 text-center">
                <h2 class="title-large text-raleway text-thick color-on-img mb30">If that simple fact seems a bit
                    discouraging</h2>
                <h3 class="title-medium text-raleway color-on-img">you may not have the power to get yourself more time,
                    but you do have the power to make the most of it</h3>
                <div class="mb50"></div>
            </div>
        </div>
    </div>
