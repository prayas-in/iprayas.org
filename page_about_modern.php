    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12 col-md-7">
                <h1 class="intro-title text-left small mb0">About us</h1>
            </div>
        ...
        <div class="row col-p30">
            ...
            <div class="col-sm-12 col-md-6">
                ...
                <div class="progress no-anim">
                    <div class="progress-bar" data-percentage="85"><span>Youth trainings 139</span></div>
                </div>
                <div class="progress no-anim">
                    <div class="progress-bar" data-percentage="70"><span>Employment genrated 18</span></div>
                </div>
                <div class="progress no-anim">
                    <div class="progress-bar" data-percentage="20"><span>Running Projects 5</span></div>
                </div>
                <div class="progress no-anim">
                    <div class="progress-bar" data-percentage="30"><span>Cities 12</span></div>
                </div>
            </div>
        </div>
    </div>
</section>
<section class="section-bg m0 data-height-fix">
    <div class="row col-p0">
        <div class="col-sm-6 hidden-xs">
            <div class=" p0 bg-img bg17 stellar" data-stellar-background-ratio="0.4">
                <div class="bg-overlay gradient-1"></div>
                ...
                <div class="row">
                    <div class="col-sm-6 col-md-3 sm-box">
                        <div class="stats-content">
                            <p class="stats-timer" data-to="5" data-speed="4000"></p>
                    ...
                    <div class="col-sm-6 col-md-3 sm-box">
                        <div class="stats-content">
                            <p class="stats-timer" data-to="19" data-speed="4000"></p>
                            <div class="br-bottom-center mt30 mb20"></div>
                            <h3>Youths Employed</h3>
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-3 xs-box">
                        <div class="stats-content">
                            <p class="stats-timer" data-to="12" data-speed="4000"></p>
                            <div class="br-bottom-center mt30 mb20"></div>
                            <h3>Cities</h3>
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-3">
                        <div class="stats-content">
                            <p class="stats-timer" data-to="166" data-speed="3500"></p>
                            <div class="br-bottom-center mt30 mb20"></div>
                            <h3>Trained Resources</h3>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-4 col-md-3 xs-box3">
                <nav>
                    <ul class="nav nav-tabs vertical">
                        <li class="active"><a href="#tab-services-1" data-toggle="tab">100+ Volunteers</a></li>
                        <li><a href="#tab-services-2" data-toggle="tab">Rural Connect</a></li>
                        <li><a href="#tab-services-3" data-toggle="tab">Research and Innovation</a></li>
                        <li><a href="#tab-services-4" data-toggle="tab">Youth Motivation</a></li>
                    </ul>
                </nav>
            </div>
