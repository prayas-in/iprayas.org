...
<div class="row">
    <div class="col-sm-12">
        <div class="grid-isotope">
            <div class="portfolio grid-col-4 grid-col-p10 portfolio-text">
                <div class="grid-col a_ b_">
            ...
            <div class="modal-body mb30">
                <div class="row col-p30">
                    ...
                    <div class="col-sm-12 col-md-6">
                        ...
                        <div class="mb30"></div>
                        <a href="index_personal.html" class="btn-e">read more</a>
                    </div>
                </div>
            </div>
        </div>
...
<div class="modal fade" id="modal-team-2" tabindex="-1" role="modal" aria-labelledby="modal-team-2" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-team">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
...
<div class="modal fade" id="modal-team-3" tabindex="-1" role="modal" aria-labelledby="modal-team-3" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-team">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
...
<div class="modal fade" id="modal-team-4" tabindex="-1" role="modal" aria-labelledby="modal-team-4" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-team">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
...
<div class="modal fade" id="modal-team-5" tabindex="-1" role="modal" aria-labelledby="modal-team-5" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-team">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
...
<div class="modal fade" id="modal-team-6" tabindex="-1" role="modal" aria-labelledby="modal-team-6" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-team">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
...
<div class="modal fade" id="modal-team-7" tabindex="-1" role="modal" aria-labelledby="modal-team-7" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-team">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
...
<div class="modal fade" id="modal-team-8" tabindex="-1" role="modal" aria-labelledby="modal-team-8" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-team">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
